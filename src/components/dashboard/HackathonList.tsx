  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h1 className="font-space font-bold text-3xl sm:text-4xl text-primary mb-4">
          DISCOVER HACKATHONS
        </h1>
        <p className="font-inter text-primary/70 max-w-2xl mx-auto text-sm sm:text-base">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="relative">
          ...
          <select
            ...
            className="pl-10 pr-8 py-3 border-2 border-primary focus:border-secondary focus:outline-none font-inter bg-background appearance-none w-full sm:w-auto"
          >
        ...
        <motion.button
          ...
          disabled={isLoading}
          className="bg-accent text-primary px-4 sm:px-6 py-3 border-2 border-primary shadow-brutal-sm hover:shadow-brutal transition-all duration-200 font-inter font-semibold disabled:opacity-50 flex items-center justify-center"
        >
      ...
      {isLoading && (
        <div className="text-center py-16 sm:py-20">
          <Loader2 className="h-12 w-12 sm:h-16 sm:w-16 text-secondary mx-auto mb-4 animate-spin" />
          <h2 className="font-space font-bold text-xl sm:text-2xl text-primary mb-2">
            LOADING HACKATHONS
          </h2>
          <p className="font-inter text-primary/70 text-sm sm:text-base">
      ...
      {error && !isLoading && (
        ...
        >
          <div className="bg-secondary/10 border-4 border-secondary shadow-brutal p-6 sm:p-8 max-w-md mx-auto">
            <h3 className="font-space font-bold text-lg sm:text-xl text-secondary mb-2">
              FAILED TO LOAD HACKATHONS
            </h3>
            <p className="font-inter text-primary/70 mb-4 text-sm sm:text-base">
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={fetchHackathons}
              className="bg-secondary text-background px-4 sm:px-6 py-2 sm:py-3 border-2 border-primary shadow-brutal-sm hover:shadow-brutal transition-all duration-200 font-inter font-semibold text-sm sm:text-base"
            >
              TRY AGAIN
            </motion.button>
          </div>
      ...
      {!isLoading && !error && sortedHackathons.length === 0 && hackathons.length > 0 && (
        <motion.div
          ...
          className="text-center py-10 sm:py-12"
        >
          <div className="bg-background border-4 border-primary shadow-brutal p-6 sm:p-8 max-w-md mx-auto">
            <Calendar className="h-12 w-12 sm:h-16 sm:w-16 text-primary/30 mx-auto mb-4" />
